...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self):
    ...
    self._WHEELTOUCH_POLICY_ALERT_1_TIMEOUT = 99995.
    self._WHEELTOUCH_POLICY_ALERT_2_TIMEOUT = 999915.
    self._WHEELTOUCH_POLICY_ALERT_3_TIMEOUT = 999925.
    self._VISION_POLICY_ALERT_1_TIMEOUT = 99995.
    self._VISION_POLICY_ALERT_2_TIMEOUT = 99998.
    self._VISION_POLICY_ALERT_3_TIMEOUT = 999913.
